...
public class cartcontroller {
    ...
    public String checkoutWithEcpay(
        ...
        try {
            ...
            // 3. 呼叫 Service (把新加的 basePath 傳進去)
            return service.genEcpayForm("ORD", finalAmount, "Credit", basePath);
    ...
    // ✅ 這是獨立的一個方法，不要包在上面那個方法裡面！
    @GetMapping("/test-pay-success")
    @ResponseBody
    public String testPaySuccess(@RequestParam String ordNo) {
        service.updateOrderPaymentStatus(ordNo, 1);
        return "已完成模擬付款！訂單 #" + ordNo + " 狀態已更新。";
    }
}