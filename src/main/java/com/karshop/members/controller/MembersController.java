package com.karshop.members.controller; // 確保這是你的 Controller 實際套件路徑
...
import com.karshop.email.EmailService;
...
//      接收註冊表單 POST 請求，處理註冊流程
  ...
  public String viewProfile(HttpSession session, Model model) {
    ...
    return "front-end/members/profile";
  }
  ...
  public String updateMember(@Valid @ModelAttribute("membersVO") MembersVO membersVO, BindingResult result,
    ...
    // 處理頭像（若上傳新圖片才更新）
    if (memAvatarFile != null && !memAvatarFile.isEmpty() && memAvatarFile.getContentType().startsWith("image/")) {
